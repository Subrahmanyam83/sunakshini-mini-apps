...
const SEED_DATA: ExerciseData = {
  ...
  exercises: [
    ...
    { id: "10", name: "Cobra Pose", duration: "30 sec hold × 3 rounds (~3 min)", description: "Extends the spine & opens the chest — counteracts forward-head posture and relieves lumbar compression from the day", bodyParts: ["back", "chest", "core"], phase: "Night", order: 10, imageUrl: "https://cdn.motra.com/exercise-assets/6ddeebfcd6/thumbnailOriginal.jpg" },
    { id: "11", name: "Downward Dog", duration: "45 sec hold × 3 rounds (~3 min)", description: "Decompresses the entire spine, stretches hamstrings & calves, and calms the nervous system before sleep", bodyParts: ["back", "legs", "shoulders"], phase: "Night", order: 11, imageUrl: "https://cdn.motra.com/exercise-assets/97e38d2a99/thumbnailOriginal.jpg" },
    { id: "12", name: "Thread the Needle", duration: "30 sec each side × 2 rounds (~2 min)", description: "Releases thoracic rotation restriction & upper back tension — unwinds the spine after a day of sitting", bodyParts: ["back", "shoulders"], phase: "Night", order: 12, imageUrl: "https://cdn.motra.com/exercise-assets/a2f8f0d44d/thumbnailOriginal.jpg" },
    { id: "13", name: "Pigeon Pose", duration: "60 sec each side × 2 rounds (~4 min)", description: "Deep hip flexor & piriformis release — relieves sciatica, SI joint pain, and hip tightness accumulated during the day", bodyParts: ["hips", "back", "nerve"], phase: "Night", order: 13, imageUrl: "https://cdn.motra.com/exercise-assets/a97cc86fa5/thumbnailOriginal.jpg" },
  ],
};
