...
const SEED_DATA: ExerciseData = {
  ...
  exercises: [
    ...
    { id: "7", name: "Supine Spinal Twist with Quad Stretch", duration: "45 sec each side (~2 min)", description: "Combines hip & spinal release — doubles SI joint decompression", bodyParts: ["back", "hips", "nerve"], phase: "Release", order: 7, imageUrl: "https://ik.imagekit.io/02fmeo4exvw/exercise-library/large/149-1.jpg" },
